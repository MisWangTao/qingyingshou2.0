                    ...
                    <div class="newContract">
                        ...
                        <div v-show="biangengData.contract_type == 2">
                            ...
                            <div class="row cols">
                                <div class="col-xs-6">
                                    ...
                                    <div class="col-xs-8"><span>￥{{biangengData.biangeng_eachMoney | numberFormat}}</span></div>
                                </div>
                                <div class="col-xs-6">
                        ...
                        <div class="row" v-show="biangengType != 3 && biangengData.contract_type != 2">
                            ...
                            <div class="col-xs-9 bgje">
                                <input type="text" value="" v-model="biangengData.biangeng_money" @input="changeBiangengmoney"/>
                                <p>
...
<script>
    ...
    export default{
        ...
        mounted(){
            this.I(this.detailData)
            this.biangengType = this.detailData.change_info.change_type
            let obj = {};
            for (let i in this.detailData.contract_info) {
                obj[i] = this.detailData.contract_info[i]
            }
            obj.arrival_amount = this.detailData.contract_info.huikuan_money
            obj.biangeng_money = this.detailData.change_info.change_money;
            obj.biangeng_why = this.detailData.change_info.change_reason;
            obj.biangeng_date = this.detailData.change_info.change_date;
            obj.maturity_dates = this.detailData.change_info.maturity_date;
            obj.tui_money = this.detailData.change_info.refund_money;
            obj.cycle = this.detailData.contract_info.contract_money/this.detailData.change_info.each_money;
            obj.biangeng_eachMoney = this.detailData.change_info.each_money;
            obj.biangeng_remark = this.detailData.change_info.remark;
            this.biangengData = obj;
            this.I(this.biangengData)
            this.files = this.detailData.files.concat()
            for(let j=0 ; j<this.detailData.returnPlan.length; j++){
                let obj = {}
                let obj1 = {}
                obj.id = this.detailData.returnPlan[j].id
                obj1.id = this.detailData.returnPlan[j].id
                obj.plan_date = this.detailData.returnPlan[j].change_plan_date
                obj1.plan_date = this.detailData.returnPlan[j].change_plan_date
                obj.plan_money = this.detailData.returnPlan[j].change_plan_money
                obj1.plan_money = this.detailData.returnPlan[j].change_plan_money
                obj.plan_type = this.detailData.returnPlan[j].change_plan_type
                obj1.plan_type = this.detailData.returnPlan[j].change_plan_type
                obj.planed_money = this.detailData.returnPlan[j].changed_plan_money
                obj1.planed_money = this.detailData.returnPlan[j].changed_plan_money
                obj.plan_remark = this.detailData.returnPlan[j].change_plan_remark
                obj1.plan_remark = this.detailData.returnPlan[j].change_plan_remark
                this.plans.push(obj)
        ...
        methods: {
            ...
            sengData(){
                ...
                let all= 0;
                for(let i=0;i<this.plansCopy.length;i++){
                    this.I(this.plansCopy[i].plan_date)
                ...
                newForm.append('change_id', contract_id)
                ...
                this.$http('FORM', '/change/edit_change.php', newForm).then(res => {
                    if(res.code == 0){
                        this.$emit('closeBiangeng')
                    }
                })
