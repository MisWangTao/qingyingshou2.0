<template>
    <div>
            ...
            <div class="madol">
                ...
                <div class="apply">
                    ...
                    <div class="state">
                        ...
                        <div class="txt"><textarea disabled v-model="message"></textarea></div>
                        <div class="buttons">
                            <button @click="closeDetail" class="btn lvBtn">取消</button>
                            <button @click="editNews" class="btn redBtn">编辑</button>
                        </div>
                    </div>
        ...
        <biangeng :id="id" :detailData="changeData" @closeBiangeng="closeShowbiangeng" v-if="showBiangeng"></biangeng>
    </div>
</template>
...
<script>
    ...
    export default{
        ...
        methods:{
            initData(){
                let id = this.id;
                this.$http('POST','/change/get_edit_details.php',{'change_id':id,'news_id':this.newsId}).then(res=>{
